  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Headline */}
        <motion.div variants={itemVariants} className="mb-[calc(1.5rem+1cm)] md:mb-6">
        ...
        <motion.p
          ...
          className="text-base md:text-xl text-[#B5B5B5] max-w-2xl mx-auto mb-[calc(2.5rem+1cm)] md:mb-10 leading-relaxed"
        >
